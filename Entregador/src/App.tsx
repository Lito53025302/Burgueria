import { Truck, Package, RefreshCw, Volume2, VolumeX, LogOut } from 'lucide-react'
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900">Pedidos para Aceitar</h2>
                </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900">Pedidos Aceitos</h2>
                </div>
                ...
                <div className="space-y-3">
                  {acceptedOrders.map((order) => (
                    <OrderCard
                      key={order.id}
                      order={order}
                      onAction={collectOrder}
                      actionLabel="Iniciar coleta"
                      disabled={updating || !!currentDelivery}
                    />
                  ))}
                </div>
