      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Nota:</strong> O entregador será criado e vinculado automaticamente a esta loja. Depois você poderá vincular o mesmo entregador em outras lojas, se desejar.
          </p>
        </div>
      </div>
    </div>
