...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            logger.error('Erro detalhado na autenticação', err);
            setError(err instanceof Error ? err.message : 'Ocorreu um erro na autenticação. Verifique os dados ou as configurações do banco.');
        } finally {
            setLoading(false);
        }
    };
