...
async function runMigration() {
    console.log('🚀 Executando migração de Cupons e Fidelidade...');

    const migrationPath = path.join(__dirname, 'migrations', '010_coupons_and_loyalty.sql');
    ...
    try {
        ...
        if (error) {
            ...
            console.log('✅ Migração de Cupons e Fidelidade concluída com sucesso!');
        }
    } catch (err) {
